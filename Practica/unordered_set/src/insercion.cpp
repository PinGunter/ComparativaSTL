 ...
 * @brief Archivo para comparar los tiempos de inserción de la estructuras de datos de la STL <unordered_set>
 */
#include <iostream>
#include <ctime>
#include <cstdlib>
...
int main(int argc, char *argv[]){
  ...
  unordered_set<int> unord_set(numeros, numeros+N);

  clock_t tini, tfin;
  tini = clock();
  unord_set.insert(N+1);
  tfin = clock();
